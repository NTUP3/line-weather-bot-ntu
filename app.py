...
# 定義共用常數
# --------------------------
CHANNEL_ACCESS_TOKEN = "gxZCUYQVNrAKg4Gznl/5yfLrtzZWPzFYIxHdOESot+JWyHwEtbxMLQ+3BgTAB00zdwmWsJrRY9lEWXEqVgGWz66BJwji9LnID7OCHRpGH7mIUptuWXXHkIoH3ZDffCgth2op/qRR9In2NESdwYbAzAdB04t89/1O/w1cDnyilFU="
GROUP_ID = "C8d6211c263ee4842704b392d45f952ee"
                ...
                if (hazard_conditions and
                    ...
                    for hazard in hazards:
                        ...
                        if not locations_msg:
                            locations_msg = ["無數據"]
                        message_text = (f"【 🌧️ {phenomenon}特報即時訊息 】\n{content_text}\n\n"
